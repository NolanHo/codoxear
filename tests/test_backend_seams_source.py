...
class TestBackendSeamsSource(unittest.TestCase):
    ...
    def test_session_routes_delegate_creation_to_owner_and_keep_server_listing_surfaces(self) -> None:
        ...
        self.assertIn("from ...runtime_facade import FacadeRequestError, build_runtime_facade", read_bootstrap)
        self.assertIn("facade.sessions_bootstrap_payload(", read_bootstrap)
